...
public class Libreria {
    ...
    public void setLibri(LinkedList<Libro> libri) {
        this.libri = libri;
    }
    ...
    public void ordinaByTitolo(){

    }

    public void ordinaByAutore(){

    }

    public void ordinaByGenere(){

    }

    public void ordinaByValutazione(){

    }

    public void ordinaByStatoLettura(){
